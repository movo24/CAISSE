        ...
        {isDesktop && (
          <div className="space-y-5">
            ...
            <div className="rounded-2xl border border-pos-border/30 p-4 bg-white/5">
              ...
              {/* La case « Imposer le format de page » a été RETIRÉE (v1.10.3) :
                  depuis la voie GDI, le ticket part en bitmap dimensionné sur la
                  mesure réelle — le bitmap EST la page. Le réglage ne faisait
                  plus rien ; le laisser cochable trompait le diagnostic. */}
              <p className="text-xs text-pos-muted mt-3">
                Le ticket est rasterisé à 203 dpi sur la largeur imprimable puis remis au pilote en
                bitmap : sa longueur suit exactement le contenu, aucun format de page n’intervient.
              </p>
            </div>
