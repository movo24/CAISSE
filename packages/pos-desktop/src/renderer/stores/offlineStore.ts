...
export type OfflineEntryType = 'ticket' | 'payment' | 'stock_movement' | 'return' | 'void' | 'antifraude_log' | 'pointage' | 'cashier_metrics' | 'staffing_snapshot' | 'credit_note_return' | 'offline_unlock_audit';
