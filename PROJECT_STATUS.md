...
- [x] **M302** RGPD : **anonymizeCustomer livré** (scrub PII en place + soft-delete + endpoint admin audité, commit 1e07f51 ; zéro enregistrement fiscal touché). Reste P2 : export portabilité ; carve-out factures si factures nominatives
